...
namespace Tools
{
    ...
    public class CRC
    {
        ...
        /// <summary>
        /// 截取Cmd 中前 Count个数据进行计算
        /// </summary>
        /// <param name="Cmd"></param>
        /// <param name="IsHighBefore"></param>
        /// <param name="count"></param>
        /// <returns></returns>
        public static byte[] GetCRC16(byte[] Cmd, bool IsHighBefore, int count)
        {
            int index;
            int crc_Low = 0xFF;
            int crc_High = 0xFF;
        ...
        /// <summary>
        /// 检测数据传输是否正确  CRC校验 最后两位为CRC
        /// </summary>
        /// <param name="data"></param>
        /// <returns></returns>
        public static bool isDataRight(byte[] data)
        {

            byte[] crc = GetCRC16(data, true, data.Length - 2);
